...
-- Modification table visiteur
ALTER TABLE visiteur ADD COLUMN comptable BOOLEAN NOT NULL DEFAULT 0 AFTER dateembauche ;

-- Ajout d'utilisateur(s) "comptable"
INSERT INTO visiteur (id, nom, prenom, login, mdp, adresse, cp, ville, dateembauche, comptable) VALUES
('p9', 'Roger', 'Jolly', 'jroger', 'p1r4t', '7 Avenue Port Royal', '63885', 'Tortuga', '2000-01-01', '1');
